...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String CREATE_TABLE="CREATE TABLE " + TABLE_REGISTER + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_USER_NAME + " TEXT," + KEY_EMAIL_ID+ " TEXT," + KEY_PASSWORD + " TEXT " + ")";
    ...
    // code to add the new register
    {
        ...
        values.put(KEY_USER_NAME,registerdata.getUserName()); // register User Name
